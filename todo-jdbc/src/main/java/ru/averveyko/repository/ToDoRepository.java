...
public class ToDoRepository implements CommonRepository<ToDo> {
    ...
    private RowMapper<ToDo> toDoRowMapper = (resultSet, rowNum) -> {
        ToDo toDo = new ToDo();
        toDo.setId(resultSet.getString("id"));
        toDo.setDescription(resultSet.getString("description"));
        toDo.setModified(resultSet.getTimestamp("modified").toLocalDateTime());
        toDo.setCreated(resultSet.getTimestamp("created").toLocalDateTime());
